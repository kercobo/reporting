...
class KiaController extends Controller
{
    ...
    public function createkia1($key){
      ...
      if(\Auth::check() && \Auth::user()->username === 'janapria'){
       ...
       elseif ($key == 'December') {
        ...
        $arr = array(
                                        array(
                                            "query" => "SELECT " . $desa . " as desa, count(*) as k1_bulan_lalu FROM kartu_anc_registration inner join kartu_ibu_registration on kartu_anc_registration.KiId = kartu_ibu_registration.KiId where  kartu_anc_registration.submissiondate between '".$begin."-01' and '".$prev."-31' group by " . $desa . "",
                                            "control" => "desa",
                                            "value" => "k1_bulan_lalu"
                                              
                                        ),
                                        array(
                                            "query" => "SELECT " . $desa . " as desa, count(*) as k1_bulan_ini FROM kartu_anc_registration inner join kartu_ibu_registration on kartu_anc_registration.KiId = kartu_ibu_registration.KiId where  kartu_anc_registration.submissiondate between '".$month."-01' and '".$month."-31' group by " . $desa . "",
                                            "control" => "desa",
                                            "value" => "k1_bulan_ini"
                                              
                                        ),
                                        array(
                                            "query" => "SELECT " . $desa . " as desa, count(*) as k4_bulan_lalu FROM kartu_anc_visit inner join kartu_ibu_registration on kartu_anc_visit.kiId = kartu_ibu_registration.KiId where kartu_anc_visit.ancKe ='4' and kartu_anc_visit.submissiondate between '".$begin."-01' and '".$prev."-31' group by " . $desa . "",
                                            "control" => "desa",
                                            "value" => "k4_bulan_lalu"
                                              
                                        ),
                                         array(
                                            "query" => "SELECT " . $desa . " as desa, count(*) as k4_bulan_ini FROM kartu_anc_visit inner join kartu_ibu_registration on kartu_anc_visit.kiId = kartu_ibu_registration.KiId where kartu_anc_visit.ancKe ='4' and kartu_anc_visit.submissiondate between '".$month."-01' and '".$month."-31' group by " . $desa . "",
                                            "control" => "desa",
                                            "value" => "k4_bulan_ini"
    ...
    public function createkia4($key){
      ...
      if(\Auth::check() && \Auth::user()->username === 'janapria'){
        ...
        $python ="/usr/bin/python " . public_path(). "/reporting.py -c " . public_path(). "/kia4/querylist.json -j " . public_path(). "/".\Auth::user()->username."/kia4/KIA4def.json -x " . public_path(). "/".\Auth::user()->username."/kia4/pws4.xlsx";
       ...
       $arr = array(
                                        ...
                                        array(
                                         ...
                                         array(
                                            "query" => "SELECT " . $desa . " as desa, count(*) as kunjungan_bulan_lalu FROM kartu_pnc_visit inner join kartu_ibu_registration on kartu_ibu_registration.kiid = kartu_pnc_visit.kiid where kartu_pnc_visit.clientVersionSubmissionDate between '".$begin."-01' and '".$prev."-31' group by " . $desa . "",
                                            "control" => "desa",
                                            "value" => "kunjungan_bulan_lalu"
                                              
                                        ),
                                         array(
                                            "query" => "SELECT " . $desa . " as desa, count(*) as kunjungan_bulan_ini FROM kartu_pnc_visit inner join kartu_ibu_registration on kartu_ibu_registration.kiid = kartu_pnc_visit.kiid where kartu_pnc_visit.clientVersionSubmissionDate between '".$month."-01' and '".$month."-31' group by " . $desa . "",
                                            "control" => "desa",
