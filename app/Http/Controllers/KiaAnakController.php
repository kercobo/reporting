  ...
  public function createkiaanak1($key){
    ...
    public function createkiaanak5($key){
      ...
      if(\Auth::user()->username === 'janapria'){
        ...
        $python ="/usr/bin/python " . public_path(). "/reporting.py -c " . public_path(). "/".\Auth::user()->username."/kiaanak5/querylist.json -j " . public_path(). "/".\Auth::user()->username."/kiaanak5/KIAanak4def.json -x " . public_path(). "/".\Auth::user()->username."/kiaanak5/kiaanak5.xlsx";
       ...
       elseif ($key == 'December') {
        ...
        $arr = array(
                                        array(
                                            "query" => "SELECT " . $desa . ", count(*) as kunjungan_bulan_lalu1 FROM kohort_bayi_balita_kunjungan inner join kartu_pnc_dokumentasi_persalinan on kohort_bayi_balita_kunjungan.childid = kartu_pnc_dokumentasi_persalinan.childid INNER JOIN kartu_anc_registration ON kartu_pnc_dokumentasi_persalinan.motherid = kartu_anc_registration.motherid INNER JOIN kartu_ibu_registration ON kartu_anc_registration.kiid = kartu_ibu_registration.kiid where kohort_bayi_balita_kunjungan.tanggalKunjunganBayiPerbulan IN ((SELECT DATEDIFF( kohort_bayi_balita_kunjungan.tanggalKunjunganBayiPerbulan,kartu_pnc_dokumentasi_persalinan.tanggallahiranak ) AS DATE FROM kohort_bayi_balita_kunjungan INNER JOIN kartu_pnc_dokumentasi_persalinan ON kohort_bayi_balita_kunjungan.childid = kartu_pnc_dokumentasi_persalinan.childid)) >= '12' and  kohort_bayi_balita_kunjungan.tanggalKunjunganBayiPerbulan IN ((SELECT DATEDIFF( kohort_bayi_balita_kunjungan.tanggalKunjunganBayiPerbulan,kartu_pnc_dokumentasi_persalinan.tanggallahiranak ) AS DATE FROM kohort_bayi_balita_kunjungan INNER JOIN kartu_pnc_dokumentasi_persalinan ON kohort_bayi_balita_kunjungan.childid = kartu_pnc_dokumentasi_persalinan.childid)) <= '23' AND kohort_bayi_balita_kunjungan.beratBadanBayiSetiapKunjunganBayiPerbulan IN (select count(*) from kohort_bayi_balita_kunjungan inner join kartu_pnc_dokumentasi_persalinan on kohort_bayi_balita_kunjungan.childid = kartu_pnc_dokumentasi_persalinan.childid INNER JOIN kartu_anc_registration ON kartu_pnc_dokumentasi_persalinan.motherid = kartu_anc_registration.motherid where kohort_bayi_balita_kunjungan.beratBadanBayiSetiapKunjunganBayiPerbulan !='') >=8 AND kohort_bayi_balita_kunjungan.submissionDate BETWEEN  '" . $begin . "-01' AND  '" . $prev . "-31' group by " . $desa . " ",
                                            "control" => "desa",
                                            "value" => "kunjungan_bulan_lalu1"
                                       ...
                                       array(
                                            "query" => "SELECT " . $desa . ", count(*) as kunjungan_bulan_ini1 FROM kohort_bayi_balita_kunjungan inner join kartu_pnc_dokumentasi_persalinan on kohort_bayi_balita_kunjungan.childid = kartu_pnc_dokumentasi_persalinan.childid INNER JOIN kartu_anc_registration ON kartu_pnc_dokumentasi_persalinan.motherid = kartu_anc_registration.motherid INNER JOIN kartu_ibu_registration ON kartu_anc_registration.kiid = kartu_ibu_registration.kiid where kohort_bayi_balita_kunjungan.tanggalKunjunganBayiPerbulan IN ((SELECT DATEDIFF( kohort_bayi_balita_kunjungan.tanggalKunjunganBayiPerbulan,kartu_pnc_dokumentasi_persalinan.tanggallahiranak ) AS DATE FROM kohort_bayi_balita_kunjungan INNER JOIN kartu_pnc_dokumentasi_persalinan ON kohort_bayi_balita_kunjungan.childid = kartu_pnc_dokumentasi_persalinan.childid)) >= '12' and  kohort_bayi_balita_kunjungan.tanggalKunjunganBayiPerbulan IN ((SELECT DATEDIFF( kohort_bayi_balita_kunjungan.tanggalKunjunganBayiPerbulan,kartu_pnc_dokumentasi_persalinan.tanggallahiranak ) AS DATE FROM kohort_bayi_balita_kunjungan INNER JOIN kartu_pnc_dokumentasi_persalinan ON kohort_bayi_balita_kunjungan.childid = kartu_pnc_dokumentasi_persalinan.childid)) <= '23' AND kohort_bayi_balita_kunjungan.beratBadanBayiSetiapKunjunganBayiPerbulan IN (select count(*) from kohort_bayi_balita_kunjungan inner join kartu_pnc_dokumentasi_persalinan on kohort_bayi_balita_kunjungan.childid = kartu_pnc_dokumentasi_persalinan.childid INNER JOIN kartu_anc_registration ON kartu_pnc_dokumentasi_persalinan.motherid = kartu_anc_registration.motherid where kohort_bayi_balita_kunjungan.beratBadanBayiSetiapKunjunganBayiPerbulan !='') >=8 AND kohort_bayi_balita_kunjungan.submissionDate BETWEEN  '" . $month . "-01' AND  '" . $month . "-31' group by " . $desa . " ",
                                            "control" => "desa",
                                            "value" => "kunjungan_bulan_ini1"
